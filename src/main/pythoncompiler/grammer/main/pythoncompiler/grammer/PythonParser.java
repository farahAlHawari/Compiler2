...
public class PythonParser extends Parser {
	...
	public static final int
		...
		DIV=40, MOD=41, AND=42, OR=43, NOT=44, LPAREN=45, RPAREN=46, LBRACK=47, 
		RBRACK=48, LBRACE=49, RBRACE=50, COLON=51, COMMA=52, DOT=53, AT=54, STRING=55, 
		NUMBER=56, IDENTIFIER=57, NEWLINE=58, WS=59, COMMENT=60;
	public static final int
		...
		RULE_augAssignStmt = 8, RULE_globalStmt = 9, RULE_routeDef = 10, RULE_decorator = 11, 
		RULE_functionDef = 12, RULE_paramList = 13, RULE_classDef = 14, RULE_block = 15, 
		RULE_ifStmt = 16, RULE_whileStmt = 17, RULE_forStmt = 18, RULE_controlStmt = 19, 
		RULE_returnStmt = 20, RULE_exprStmt = 21, RULE_expression = 22, RULE_logicalExpr = 23, 
		RULE_comparisonExpr = 24, RULE_arithmeticExpr = 25, RULE_term = 26, RULE_factor = 27, 
		RULE_primary = 28, RULE_listLiteral = 29, RULE_dictLiteral = 30, RULE_dictEntry = 31, 
		RULE_argList = 32, RULE_argument = 33;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "stmt", "blockStmt", "tryStmt", "withStmt", "emptyStmt", "importStmt", 
			"assignmentStmt", "augAssignStmt", "globalStmt", "routeDef", "decorator", 
			"functionDef", "paramList", "classDef", "block", "ifStmt", "whileStmt", 
			"forStmt", "controlStmt", "returnStmt", "exprStmt", "expression", "logicalExpr", 
			"comparisonExpr", "arithmeticExpr", "term", "factor", "primary", "listLiteral", 
			"dictLiteral", "dictEntry", "argList", "argument"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 559202817853615336L) != 0)) {
				{
				{
				setState(68);
				stmt();
	...
	public final TryStmtContext tryStmt() throws RecognitionException {
		...
		try {
			...
			while (_la==EXCEPT) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 252958043191377920L) != 0)) {
					{
					setState(101);
					expression();
					}
	...
	public final AugAssignStmtContext augAssignStmt() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_augAssignStmt);
		int _la;
		try {
	...
	public final RouteDefContext routeDef() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_routeDef);
		try {
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 541188419344133344L) != 0) );
			setState(203);
			match(DEDENT);
			}
		}
	...
	public final ArithmeticExprContext arithmeticExpr() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_arithmeticExpr);
		int _la;
		try {
	...
	public final DictEntryContext dictEntry() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_dictEntry);
		try {
